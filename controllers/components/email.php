...
/**
 * Sends out email via SMTP Auth TLS...
 *
 */
	function __smtpAuthTLS(){
		vendor('Swift');
		vendor('Swift/Connection/SMTP');

		$smtp = new Swift_Connection_SMTP($this->smtpOptions['host'], 
		...
		$message = new Swift_Message($this->subject, $this->__message);
